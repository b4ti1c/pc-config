on run argv
    tell application "Terminal"
        ...
        do script "DEBUG=* npm start" in front window
        ...
        do script "DEBUG='connection-tracker-master:*' npm start" in front window
        ...
        do script "DEBUG='datasourcefetcher-master:*' npm start" in front window
        ...
        do script "DEBUG='channel-scheduler-master:*' npm start" in front window
        ...
        do script "DEBUG='datasourcefetcher-worker:*' npm start" in front window
        ...
        do script "DEBUG='media-worker:*, static-storage:*' npm start"in front window
        ...
        do script "DEBUG='webapi-worker:*, core-worker:*, static-storage:*' npm start" in front window
        ...
        do script "DEBUG='core-worker:*, static-storage:*' npm start" in front window
        ...
        do script "DEBUG='socket-worker:*' npm start" in front window
